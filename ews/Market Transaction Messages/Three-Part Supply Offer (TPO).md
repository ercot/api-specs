...
![ThreePartOffer Structure](../Images/ThreePartOffer_Structure.png)
...
![PriceCurve Structure](../Images/PriceCurve_Structure.png)
...
![FipFop, Startup Cost and MinimumEnergy Structure](../Images/FipFop_StartUp_Structures.png)
...
<ns1:BidSet xmlns:ns1="http://www.ercot.com/schema/2007-06/nodal/ews">
    ...
    <ns1:ThreePartOffer>
        ...
        <ns1:error>
            <ns1:severity>INFORMATIVE</ns1:severity>
            <ns1:text>Successfully processed the ERCOT Three Part Offer.</ns1:text>
        </ns1:error>
    </ns1:ThreePartOffer>
</ns1:BidSet>
~~~
