...
<xsl:for-each select="ROWSET">
  <AMSINTERVAL_DATA xmlns = "http://www.ercot.com/xsd/2006-06/MarketDataTransparency"
                     xmlns:MDT = "http://www.ercot.com/xsd/2006-06/MarketDataTransparency">
    <xsl:for-each select="ROW">
      <AMSINTERVAL>
      <xsl:element name="UIDAMSINTERVAL">		
        <xsl:value-of select="UIDAMSINTERVAL" />		
      </xsl:element>					
      <xsl:element name="UIDESIID">
        <xsl:value-of select="UIDESIID" />
      </xsl:element>
      <xsl:element name="UIDAMSDATATYPE">
        <xsl:value-of select="UIDAMSDATATYPE" />
      </xsl:element>
      ...
      <xsl:element name="UIDAMSREGISTEREDFILE">
        <xsl:value-of select="UIDAMSREGISTEREDFILE" />
      </xsl:element>
      <xsl:element name="PROXYDAY">		
        <xsl:value-of select="PROXYDAY" />		
      </xsl:element>					
      ...
      <xsl:element name="METERREADTS">
        <xsl:value-of select="METERREADTS" />
      </xsl:element>
      <xsl:element name="TZSTDNAME">		
        <xsl:value-of select="TZSTDNAME" />		
      </xsl:element>					
